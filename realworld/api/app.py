...
def _register_blueprints(app: Flask):
    app.register_blueprint(
        articles_blueprint,
        url_prefix=f"/api{articles_blueprint.url_prefix}"
    )
    app.register_blueprint(
        users_blueprint,
        url_prefix=f"/api{users_blueprint.url_prefix}"
    )
    app.register_blueprint(
        profiles_blueprint,
        url_prefix=f"/api{profiles_blueprint.url_prefix}"
    )
    app.register_blueprint(
        tags_blueprint,
        url_prefix=f"/api{tags_blueprint.url_prefix}"
    )
